...
class VendorController extends Controller
{
            ...
            ->addColumn('action', function ($users) {
                return '<div class="dropdown dropdown-inline">
								<a href="" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown">
							  	...
							  	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
									<ul class="nav nav-hoverable flex-column">
							    		<li class="nav-item"><a class="nav-link" href="'.route('admin.vendor-user-show',Crypt::encrypt($users->id)).'"><i class="nav-icon la la-user"></i><span class="nav-text">View Vendor Transactions</span></a></li>
							    		<li class="nav-item"><a class="nav-link" href="'.route('admin.vendor-user-edit',Crypt::encrypt($users->id)).'"><i class="nav-icon la la-edit"></i><span class="nav-text">Edit Details</span></a></li>
							    		<li class="nav-item"><a class="nav-link" href="#"><i class="nav-icon la la-stop-circle"></i><span class="nav-text">Suspend Vendor</span></a></li>
							    	</ul>
							  	</div>
							</div>
    ...
    public function vendorShow($id)
    {
        try {
            ...
            $totalTransaction = $this->getUserTotalTransaction($user->id);
            $transactionCount = $this->transactionCount($user->id);
            return view('admin.vendors.vendor-user-show',compact('user','phones','totalTransaction','transactionCount'));
        }
        catch (ModelNotFoundException $e) {
            return $e;
        }
    ...
    public function vendorEdit($id)
    {
        try {
            ...
            $phones = $provider->phone_numbers()->where('user_id','=', $id)->get();
            //return  $phones;
            return view('admin.vendors.vendor-user-edit',compact('provider','phones'));
        }
        catch (ModelNotFoundException $e) {
            return $e;
        }
