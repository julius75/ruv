...
{{--                                    <i class="la la-phone">{{$phone->phone_number}}</i>--}}
                ...
                <div class="card">
                    ...
                    <div class="card-body transaction-graph-card">
                        <div class="chart-bar"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                            <canvas id="transactionsChartVendors" width="668" height="320" class="chartjs-render-monitor" style="display: block; width: 668px; height: 320px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card card-custom  gutter-b">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Vendor Transactions</h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
...
@section('scripts')
        ...
        function userTransaction() {
            var initTable1 = function() {
                ...
                table.DataTable({
                    responsive: true,
                    ajax: {
                        url: '{{route('admin.get-transactions_vendor',$user->id)}}',
                        type: 'GET',
                        data: {
                            pagination: {
                                perpage: 1000,
    ...
    <script>
        ...
        function transactionsDrawGraph(data){
            var elementId="transactionsChartVendors"
            var chartType="bar"
