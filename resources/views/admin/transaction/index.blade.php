...
@section('content')
    ...
    <div class="row m-0">
        <div class="col bg-light-info px-6 py-8 rounded-xl mr-7 mb-7">
            ...
            <a href="#" class="text-info font-weight-bold font-size-h6">Total Transactions: {{count($transactions)}}</a>
        </div>
        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
            ...
            <a href="#" class="text-warning font-weight-bold font-size-h6">Pending Approvals: {{count($pendingApproval)}}</a>
        </div>
        <div class="col bg-light-success px-6 py-8 rounded-xl  mr-7 mb-7">
            ...
            <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Completed Transactions: {{count($completedTransactions)}}</a>
        </div>
        <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
            ...
            <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Pending Issuing by Vendors: {{count($pendingIssuing)}} </a>
        </div>
    </div>
    <!--begin::Card-->
